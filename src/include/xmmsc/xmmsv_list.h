...
int xmmsv_list_get_coll (xmmsv_t *v, int pos, xmmsv_coll_t **val) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_list_set_coll (xmmsv_t *v, int pos, xmmsv_coll_t *val) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_list_insert_coll (xmmsv_t *v, int pos, xmmsv_coll_t *val) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_list_append_coll (xmmsv_t *v, xmmsv_coll_t *val) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_list_iter_entry_coll (xmmsv_list_iter_t *it, xmmsv_coll_t **val) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_list_iter_insert_coll (xmmsv_list_iter_t *it, xmmsv_coll_t *val) XMMS_PUBLIC XMMS_DEPRECATED;
/** @} */
