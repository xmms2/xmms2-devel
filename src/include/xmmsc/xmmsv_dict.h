...
int xmmsv_dict_entry_get_coll (xmmsv_t *val, const char *key, xmmsv_coll_t **coll) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_dict_set_coll (xmmsv_t *val, const char *key, xmmsv_coll_t *el) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_dict_iter_pair_coll (xmmsv_dict_iter_t *it, const char **key, xmmsv_coll_t **r) XMMS_PUBLIC XMMS_DEPRECATED;
...
int xmmsv_dict_iter_set_coll (xmmsv_dict_iter_t *it, xmmsv_coll_t *elem) XMMS_PUBLIC XMMS_DEPRECATED;
/** @} */
