...
#define XMMS_TRANSPORT_SEEK_SET SEEK_SET
#define XMMS_TRANSPORT_SEEK_END SEEK_END
#define XMMS_TRANSPORT_SEEK_CUR SEEK_CUR
...
gint xmms_transport_seek (xmms_transport_t *transport, gint offset, gint whence);
