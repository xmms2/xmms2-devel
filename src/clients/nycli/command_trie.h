...
void command_trie_fill (command_trie_t* trie, command_action_t commands[]);
gboolean command_trie_insert (command_trie_t* trie, gchar *string, command_action_t *action);
