...
xmmsc_result_t *
xmmsc_medialib_select_and_add (xmmsc_connection_t *c, char *query)
{
	DBusMessageIter itr;
	DBusMessage *msg;
	xmmsc_result_t *res;
	
	msg = dbus_message_new_method_call (NULL, XMMS_OBJECT_MEDIALIB, XMMS_DBUS_INTERFACE, XMMS_METHOD_SELECTANDADD);
