...
x_list_t*
x_list_insert_before (x_list_t   *list,
		      x_list_t   *sibling,
		      void * data)
{
  if (!list)
...
x_list_t*
x_list_remove_all (x_list_t	*list,
		   const void * data)
{
  x_list_t *tmp = list;
...
_x_list_remove_link (x_list_t *list,
		     x_list_t *link)
{
  if (link)
    {
...
x_list_t*
x_list_remove_link (x_list_t *list,
		    x_list_t *link)
{
...
x_list_t*
x_list_delete_link (x_list_t *list,
		    x_list_t *link)
{
...
x_list_t*
x_list_find_custom (x_list_t         *list,
		    const void *  data,
		    XCompareFunc   func)
{
  assert (func != NULL);
...
x_list_t*
x_list_insert_sorted (x_list_t        *list,
                      void *      data,
                      XCompareFunc  func)
{
