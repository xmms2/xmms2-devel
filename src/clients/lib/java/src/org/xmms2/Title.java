...
public class Title implements Comparable{
	...
	/**
	 * Adds/Sets a key to a specified value. keys are stored and received lowercase
	 * 
	 * @param key
	 * @param value
	 */
	...
	public boolean equals(Object o){
		...
		Title t = (Title)o;
		if (t.getAttributes().size() != getAttributes().size()) return false;
	...
	public int compareTo(Object arg0) {
		if (arg0 instanceof Title){
			Title t = (Title)arg0;
			try {
				return new Integer(getAttribute("id")).compareTo(new Integer(t.getAttribute("id")));
			} catch (Exception e){}
		}
		return 0;
	}
