...
gboolean xmms_playlist_add_id (xmms_playlist_t *playlist, xmms_medialib_entry_t file, xmms_error_t *error);
...
gboolean xmms_playlist_add_url (xmms_playlist_t *playlist, gchar *nurl, xmms_error_t *err);
