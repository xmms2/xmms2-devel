...
gboolean xmms_decoder_init_for_decoding (xmms_decoder_t *decoder, GList *output_format_list, GList *effects);
gboolean xmms_decoder_init_for_mediainfo (xmms_decoder_t *decoder);
