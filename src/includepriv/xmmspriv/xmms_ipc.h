...
void xmms_ipc_send_message (gint64 cli, xmms_ipc_msg_t *msg, xmms_error_t *err);
void xmms_ipc_send_broadcast (guint broadcastid, gint64 cli, xmmsv_t *arg, xmms_error_t *err);
